...
<main class="contenedor seccion">
    ...
    <form class="formulario" method="post" enctype="multipart/form-data">
        <fieldset>
            ...
            <img class="imagen-small" src="/imagenes/<?php echo $imagenPropiedad; ?>" alt="Imagen de la propiedad">
        ...
        <fieldset>
            ...
            <input type="number" id="habitaciones" name="habitaciones" placeholder="Número de habitaciones. Ej: 3"
                   min="1" max="9" value="<?php echo $habitaciones; ?>">

            <label for="wc">Baños:</label>
            <input type="number" id="wc" name="wc" placeholder="Número de baños. Ej: 3" min="1" max="9"
                   value="<?php echo $wc; ?>">

            <label for="estacionamiento">Estacionamiento:</label>
            <input type="number" id="estacionamiento" name="estacionamiento"
                   placeholder="Número de estacionamientos. Ej: 3" min="1" max="9"
